...
async def over_under_traitement(lien,lien1,unxbet,ligue,LI,betkeen,_1xbet,a,data1,a1,*args,**kwargs):
    ...
    if marge <0.05 and over_betkeen<20 and under_betkeen<20:
...
async def over_under_recuperation(a):
    ...
    url = f"https://1xlite-497172.top/service-api/LiveFeed/GetGameZip?id={Id}&lng=fr&tzo=2&isSubGames=true&GroupEvents=true&countevents=250&grMode=2&country=172&marketType=1"
    try:
    ...
    LI=data["Value"]["LI"]
    lien=f"https://betwinner1.com/fr/live/football/{LI}-{ligue}/{Id}-{unxbet}"
    print(lien)
