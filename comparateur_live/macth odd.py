...
async def match_odd_recuperation(a):
    ...
    url = f"https://1xbet.com/LiveFeed/GetGameZip?id={Id}&lng=fr&tzo=2&isSubGames=true&GroupEvents=true&countevents=50&grMode=2&country=192&marketType=1&mobi=true"
    try :
